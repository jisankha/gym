...
<style>
	...
	nav#sidebar{
		background: url(assets/img/sidebar.jpg) !important
	}
</style>

<nav id="sidebar" class="mx-lt-5 bg-dark shadow">
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=registered_members" class="nav-item nav-registered_members"><span class='icon-field'><i class="fa fa-id-card"></i></span> Memberships</a>
